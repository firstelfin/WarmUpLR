...
def show_lr(epoch=1, start_epoch=0, end_epoch=42):
    ...
    y1 = []
    y2 = []
    x1 = np.linspace(start_epoch+1, end_epoch+1, (end_epoch - start_epoch) * param["steps"])
    ...
    if epoch > warm_up_lr.warm_up_epoch:
        warm_up_lr.origin_lr.epoch_step_modify(epoch-warm_up_lr.warm_up_epoch)
